"""
Сервисный слой производителей. В данной итерации проекта не используются.
"""
...
class ManufacturersServices:
    ...
    async def get_manufacturers(self, filters: SCountriesFilters | None = None):
        ...
        return await self.db.manufacturers.select_all(filter_by)
    ...
    async def add_manufacturer(self, data: SManufacturers):
        ...
        return await self.db.manufacturers.insert_one(data)
    ...
    async def edit_manufacturer(self, manufacturer_id: UUID, data: SManufacturers, exclude_unset=False):
        ...
        return await self.db.manufacturers.update(
            data,
            id=manufacturer_id,
    ...
    async def delete_manufacturer(self, manufacturer_id: UUID):
        ...
        return await self.db.manufacturers.delete(id=manufacturer_id)
