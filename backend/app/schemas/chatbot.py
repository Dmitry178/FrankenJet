...
class SChatBotSettings(BaseModel):
    ...
    system_prompt: str | None = Field(None, description="Общий системный промт")
    rag_prompt: str | None = Field(None, description="Системный промт для RAG-бота")
    feedback: str | None = Field(None, max_length=128, description="Ответ на вопрос по обратной связи")
