...
class SAircraft(BaseModel):
    ...
    aircraft_type: str | None = Field(None, max_length=32, description="Тип воздушного судна")  # TODO: уточнить размер
    ...
    engine_type: str | None = Field(None, max_length=32, description="Тип двигателя")  # TODO: уточнить длину (enum)
    ...
    status: str | None = Field(None, max_length=32, description="Статус самолета")  # TODO: уточнить длину (enum)
