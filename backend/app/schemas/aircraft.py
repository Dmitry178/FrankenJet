...
class SAircraft(BaseModel):
    ...
    aircraft_purpose: str | None = Field(None, max_length=24, description="Назначение воздушного судна")
    ...
    image_license: str | None = Field(None, max_length=64, description="Лицензия изображения")
