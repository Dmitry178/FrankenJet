...
│  ├─ 📁 app                   # Основной исходный сервиса
│  ├─ 📁 proto                 # Определения gRPC-сервисов и сообщений
...
* **Backend:**
  ...
  * Поиск по статьям через Elasticsearch (или через SQL-запросы при недоступности Elasticsearch).
