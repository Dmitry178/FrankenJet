...
Swagger UI бэкенда доступен по адресу: http://localhost:9999/api/docs
...
| Backend     | —          | —                 | admin   | password | [http://localhost:9999/api/docs](http://localhost:9999/api/docs) |
| Bot         | —          | —                 | —       | —        | —                                                                |
